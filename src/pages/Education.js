    ...
    <div className="p-8 max-w-4xl mx-auto bg-gray-50 shadow-sm rounded-lg">
      ...
      <div className="space-y-6">
        <div className="flex justify-between">
          ...
          <p className="text-gray-600 italic">01/2022 – Present</p>
        </div>
        <div className="flex justify-between">
          <div>
          ...
          <p className="text-gray-600 italic">01/2017 – 03/2019</p>
        </div>
        <div className="flex justify-between">
          <div>
          ...
          <p className="text-gray-600 italic">02/2014 – 11/2016</p>
        </div>
      </div>
    </div>
  );
