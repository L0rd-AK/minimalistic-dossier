    ...
    <div className="p-4 sm:p-8 max-w-4xl mx-auto bg-gray-50 shadow-sm rounded-lg">
      ...
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:justify-between">
          ...
          <p className="text-purple-600 font-medium italic sm:text-right">[01/2022 – Present]</p>
        </div>
        <div className="flex flex-col sm:flex-row sm:justify-between">
          <div className="mb-2 sm:mb-0">
          ...
          <p className="text-purple-600 font-medium italic sm:text-right">[01/2017 – 03/2019]</p>
        </div>
        <div className="flex flex-col sm:flex-row sm:justify-between">
          <div className="mb-2 sm:mb-0">
          ...
          <p className="text-purple-600 font-medium italic sm:text-right">[02/2014 – 11/2016]</p>
        </div>
      </div>
    </div>
  );
