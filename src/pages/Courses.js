      ...
      <ul className="space-y-4">
        <li className="hover:bg-blue-50 p-2 rounded-md transition-colors">
          <div className="flex justify-between">
            ...
            <span className="text-purple-600 font-medium italic px-2 rounded">[06/2022]</span>
          </div>
        ...
        <li className="hover:bg-blue-50 p-2 rounded-md transition-colors">
          <div className="flex justify-between">
            ...
            <span className="text-purple-600 font-medium italic  px-2 rounded">[02/2023]</span>
          </div>
        ...
        <li className="hover:bg-blue-50 p-2 rounded-md transition-colors">
          <div className="flex justify-between">
            ...
            <span className="text-purple-600 font-medium italic px-2 rounded">[06/2023]</span>
          </div>
